###############################################################
# Plot voltage data generated by Kaifa MA304H3E AMS meter,    #
# saved to usb stick on Raspberry Pi.                         #
#                                                             #
# Note: MA304H3E only shows only L1 and L2 with 230V mains.   #
###############################################################
...
def main(fileName, hour1, hour2):
  ...
  ax.grid(which='both')
  ax.legend()
  plt.savefig("volts.png", dpi=200, bbox_inches='tight')
